...
# Load environment variables (locally from .env, on Render from environment)
load_dotenv()
...
# Sales tracking data (in-memory; resets on Render restart - consider a database for production)
sales_data = {
...
# In-memory store for user states (resets on Render restart - consider persistence later)
user_states = {}
